  ...
  const columns = [
    ...
    { field: 'telefone.whatsapp', headerName: 'WhatsApp', width: 150, hide: true },
    {
      ...
      renderCell: (params) => {
        ...
        return <Button variant="contained" color="secondary" onClick={onClick}>Visualzar</Button>;
      }
    },
  ];
  ...
  return (
      <Box m="20px">
        <Header
            ...
            subtitle="Gera demonstrativo e controla a folha de pagamento dos funcionários"
        />
        <Box
            m="40px 0 0 0"
            height="75vh"
